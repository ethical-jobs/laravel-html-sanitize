...
class SpacingTest extends \Tests\TestCase
{
    ...
    public function it_removes_multiple_spaces()
    {
        ...
        $this->assertEquals($output, '<p>Successful candidates will be required to clear probity checks including <strong> Hello </strong></p>');
    }          
}
